    ...
    <header className="bg-header-mobile md:bg-header flex flex-row fixed justify-between px-6 md:px-0 md:justify-center items-center w-full py-8 text-custom-light z-50 pointer-events-none gap-x-2">
      ...
      <div className="relative flex pointer-events-auto justify-center items-center font-medium bg-custom-light w-fit h-fit rounded-full bg-opacity-5 text-sm border border-opacity-10 border-custom-light backdrop-blur">
        ...
        >
          {progressState === "start" && (
            <>
              <span className="font-medium text-xs text-custom-light text-opacity-60">
                {work.title}
              </span>
              <div className="flex flex-row items-center gap-x-1.5 text-end">
                <span className="font-medium text-xs w-fit">
                  {work.association}
                </span>
                <div
          ...
          {progressState === "scrolling" && (
            <>
              ...
              <motion.span className="font-medium text-xs text-custom-light text-opacity-60">
                {displayPercentage}%
              </motion.span>
            </>
          )}
          {progressState === "complete" && (
            <>
              ...
              <div className="flex flex-row items-center gap-x-1.5 text-end">
                <span className="font-medium text-xs w-full">
                  {nextWork.title}
                </span>
                <div
                  className="shrink-0 w-[6px] h-[6px] rounded-full"
