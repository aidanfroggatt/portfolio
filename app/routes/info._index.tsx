      ...
      >
        ...
        >
          ...
          <h1 className="text-shadow-mobile md:text-shadow">
            Here&apos;s some more info&nbsp;<span className="h1-accent">about me.</span>
          </h1>
        </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <h5>{exp.team && <span className="text-custom-light/70">{exp.team}</span>}</h5>
  ...
  return (
    <section id="involvement">
      ...
      >
        ...
        <div className="flex flex-col gap-y-16 md:gap-y-20 2xl:gap-y-28">
          {involvement &&
            involvement.map((inv: involvement, index) => {
              return (
                <div
                  key={index}
                  className="flex flex-col md:grid md:grid-cols-2 md:gap-x-20 justify-start items-start"
                >
                  ...
                  >
                    ...
                    <h5>{inv.team && <span className="text-custom-light/70">{inv.team}</span>}</h5>
                    <span className="text-custom-light/50 text-sm md:text-base 2xl:text-lg mt-2 md:mt-1.5 2xl:mt-2">
