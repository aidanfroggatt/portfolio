...
export const work: Work[] = [
  {
    ...
    subtitle:
      "Data analytics and report generation platform for additive manufacturing.",
    description:
    ...
    content: [
      ...
      },
      {
        ...
        subtitle:
          "A time-consuming and error-prone process, wasting engineering hours.",
        description:
      ...
      },
      {
        ...
        subtitle:
          "Without analysis, engineering decisions were not data-driven.",
        description:
      ...
      },
      {
        ...
        subtitle:
          "Tangible results and valuable insights, but always room for improvement",
        description:
  ...
  },
  {
    ...
    highlights: {
      description:
        "An award-winning AI-powered tool for detecting the recyclability of items.",
      items: [
        {
          asset: {
  ...
  },
  {
    ...
    highlights: {
      description:
        "Visualizers for mesh data structure and applicable algorithms.",
      items: [
        {
          asset: {
  ...
  // },
  {
    ...
    association: "McMaster University",
    description:
      "ACME Run is a gamified fitness platform combining curated running trails and heart rate monitoring to provide a dynamic fitness experience. Designed for North American users, it promotes community engagement and user safety through local partnerships. The project focuses on requirements engineering and system architecture, with a vision to make fitness more accessible and enjoyable.",
    asset: {
    ...
    content: [
      ...
      },
      {
        ...
        subtitle:
          "The components required to create a dynamic fitness solution",
        description:
  ...
  },
  {
    ...
    overview: {
      ...
      role: {
        ...
        description:
          "Building automation tooling, testing suites, and validation frameworks.",
      },
      technologies: [
