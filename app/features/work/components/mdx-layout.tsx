...
export const WorkEvolution = ({
  ...
  return (
    <div className="flex flex-col w-full relative">
      <div className="absolute left-mac-window-dot-2xl top-6 bottom-6 w-px bg-custom-light/5 overflow-hidden z-0 rounded-full">
        <motion.div
          animate={{ top: ['0%', '100%'] }}
          transition={{ repeat: Infinity, duration: 4, ease: 'linear' }}
          className="absolute left-1/2 -translate-x-1/2 w-px h-15 flex justify-center"
          style={{ background: `linear-gradient(to bottom, transparent, ${color}, transparent)` }}
        >
          <div
            className="absolute top-1/2 -translate-y-1/2 w-0.5 h-mac-window-dot-2xl rounded-full blur-[1px] opacity-80"
      ...
      >
        <div className="flex flex-row items-start gap-x-6 md:gap-x-8 md:w-1/3 shrink-0">
          <div className="w-8 h-8 rounded-full border border-custom-light/10 bg-custom-dark-alt flex items-center justify-center shrink-0 mt-1 relative z-10 shadow-sm">
            <div className="w-1.5 h-1.5 rounded-full bg-custom-light/30" />
          </div>
          <div className="flex flex-col pt-1.5">
            <span className="text-xl md:text-2xl font-medium text-custom-light/80 leading-tight">
              {contextHeading}
            </span>
          </div>
        </div>
      ...
      >
        <div className="flex flex-row items-start gap-x-6 md:gap-x-8 md:w-1/3 shrink-0">
          <div
            className="w-8 h-8 rounded-full border bg-custom-dark-alt flex items-center justify-center shrink-0 mt-1 relative z-10 shadow-lg"
          ...
          <div className="flex flex-col pt-1.5">
            <span className="text-xl md:text-2xl font-medium text-shadow leading-tight">
              {evolutionHeading}
            </span>
          </div>
        </div>
        <div className="md:w-2/3 text-custom-light/90 text-base md:text-lg leading-relaxed font-light pl-14 md:pl-0 pt-1.5">
          {evolution}
        </div>
      </motion.div>
    </div>
